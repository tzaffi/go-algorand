...
* is a kind of dry-run since the it has a lifetime of ~30s
* it can accept any scenario as its second argument, but defaults to [test_config.yml](./test_config.yml)
