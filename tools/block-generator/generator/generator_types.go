...
type generator struct {
	...
	// cycleSize when nonzero specifies the size of the block/state delta cycles
	cycleSize uint64

	// blockCycle stores the first few blocks generated by the ledger
	// not including the genesis block.
	blockCycle []bookkeeping.Block
	
	// stateDeltaCycle stores the first few state deltas generated by the ledger
	stateDeltaCycle []ledgercore.StateDelta
}
